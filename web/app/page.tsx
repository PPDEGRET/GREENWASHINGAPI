  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light text-dark-grey">
      <div className="flex h-auto min-h-screen flex-col">
        <div className="flex flex-1 justify-center px-4 pb-16 pt-6 md:px-10 lg:px-20 xl:px-40">
          <div className="flex w-full max-w-[960px] flex-1 flex-col">
            <header className="flex items-center justify-between whitespace-nowrap border-b border-neutral-grey/30 px-4 py-4 sm:px-6 lg:px-10">
              <div className="flex items-center gap-3 text-dark-grey">
                <div className="size-8 rounded-full bg-primary/20 text-primary">
                ...
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-neutral-grey">LeafCheck</p>
                  <h2 className="text-base font-semibold text-dark-grey">AI Greenwashing Detector</h2>
                </div>
              </div>
              <div className="hidden flex-1 items-center justify-end gap-8 md:flex">
                <div className="flex items-center gap-9 text-sm font-medium text-dark-grey">
                  {navLinks.map((item) => (
            ...
            <main className="flex flex-col gap-12 px-4 py-12 md:px-8 md:py-16">
              <section className="flex flex-col items-center gap-6 text-center">
                <h1 className="max-w-3xl text-4xl font-black leading-tight tracking-[-0.033em] text-dark-grey md:text-5xl">
                  Upload an ad — get a greenwashing risk analysis.
                </h1>
                <p className="max-w-2xl text-base leading-relaxed text-dark-grey md:text-lg">
              ...
              <section className="rounded-xl border-2 border-dashed border-neutral-grey/50 bg-white px-6 py-14 text-center shadow-sm">
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="flex max-w-[480px] flex-col items-center gap-2">
                    ...
                    <p className="text-sm leading-normal text-neutral-grey">
                      Our AI will analyze your ad for greenwashing.
                    </p>
                  </div>
                  <Button>Browse Files</Button>
                  <p className="text-xs text-neutral-grey">Limit 20MB per file. PNG, JPG, PDF supported.</p>
                </div>
              </section>

              <section className="flex flex-col gap-10">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                  <article className="flex flex-col gap-4 rounded-xl border border-neutral-grey/30 bg-background-light p-6 text-left shadow-sm transition-shadow hover:shadow-md">
